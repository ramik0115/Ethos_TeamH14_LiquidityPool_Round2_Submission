...
const Header = ({setActiveComponent, activeNetwork}) => {
  // menu list
  const navMenu = [
    "Home", "Liquidity", "Pool History", "Liquidity History", "Networks",
  ];
  return(
      ...
      <div className="container">
        <nav className="">
          ...
          <div className="lg:hidden flex items-center ms-auto px-2.5">
            <button className="hs-collapse-toggle inline-flex items-center justify-center h-9 w-12 rounded-md border border-white/20 bg-default-100/5"
            type="button"
            id="hs-unstyle-collapse"
