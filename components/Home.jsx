            ...
            <div className="flex justify-center">
              <div className="max-w-2xl">
                ...
                <p className="text-base text-default-200 font-medium px-5">
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nostrum commodi ipsa atque eligendi eaque laboriosam cumque suscipit numquam animi tempora repellendus corrupti non sunt quasi ipsum, earum quibusdam omnis repudiandae expedita nobis ad mollitia recusandae veritatis? Fugiat saepe quisquam cum.
                </p>
                ...
                <div className="backdrop-blur-2xl bg-white/10 rounded-md max-w-xl mx-auto">
                  <div className="w-full flex items-center justify-between mt-7">
                    <input type="text" className="w-full p-4 border-0 focus:outline-none focus:ring-0 text-sm text-white placeholder:text-white bg-transparent"
                    ...
                    <button className="py-2 px-6 me-2 border-0 text-white font-semibold text-sm rounded-md backdrop-blur-2xl bg-primary hover:bg-primary-hover hover:text-white transition-all duration-500">
                      <div onClick={() => CALL_POOL_DETAIL(poolAddress)} className="flex items-center justify-center gap-1">
                        <span>Submit</span>
                      </div>
                    </button>
                  </div>
